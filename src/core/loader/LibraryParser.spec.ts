...
describe("Library Parser", function () {
    ...
    it("parses library with one book", function () {
        const parser = new LibraryParser();
        const lib = parser.parse(LibOneBook, new FileLoader(), new PathMerger("http://test.local/mdc/"));
    ...
    it("parses library with one book and several chapters", function () {
        const parser = new LibraryParser();
        const lib = parser.parse(LibOneBookSeveralChapters, new FileLoader(), new PathMerger("http://test.local/mdc/"));
    ...
    it("parses library with multiple books and several chapters", function () {
        const parser = new LibraryParser();
        const lib = parser.parse(LibMultipleBooks, new FileLoader(), new PathMerger("http://test.local/mdc/"));
